...
function uploadImage($form){
  ...
  request.open('post', 'Trkib_c/upload');
...
$(document).ready(function(){
  ...
  document.getElementById("sm5").style.color = "white";
  document.getElementById("sm5").style.fontWeight = "bold";
...
function sensus(id_barang,key){
  ...
  $.ajax({
    ...
    type : 'POST',
    data : {id_barang},
    url : 'Trkib_c/get_Trkib_c_id_non',
    ...
    success : function(data){
      ...
      if (data[0].konstruksi3=='' || data[0].konstruksi3==null) {
        $('#konstruksi').val(data[0].konstruksi);
      }else {
        $('#konstruksi').val(data[0].konstruksi3);
      }
      $('#konstruksi_awal').text(data[0].konstruksi);

      if (data[0].jenis_gedung2=='' || data[0].jenis_gedung2==null) {
        $('#jns_gedung').val(data[0].jenis_gedung);
      }else {
        $('#jns_gedung').val(data[0].jenis_gedung2);
      }
      $('#jns_gedung_awal').text(data[0].jenis_gedung);

      if (data[0].luas_lantai2=='' || data[0].luas_lantai2==null) {
        $('#luas').val(data[0].luas_lantai);
      }else {
        $('#luas').val(data[0].luas_lantai2);
      }
      $('#luas_awal').text(data[0].luas_lantai);
      ...
      if (data[0].no_sensus=='' || data[0].no_sensus==null) {
        ...
        $('#no_header').text("C-"+data[0].no_sensus);
        $('#no_header').show();
      }
...
function submit(stat_submit) {
  ...
  $.ajax({
    url:"Trkib_c/simpan_Trkib_c",
    method : "post",
    data:{stat_submit,id_brg,dtl_brg,konstruksi,jns_gedung,luas,tgl_dok,no_dok,alamat,lat,lon,ket,kronologis,stat_fisik,keberadaan_brg,kondisi_brg,stat_hukum,bukti_milik,status_milik,ket_brg,ket_stat_hukum,no_surat_pol},
    async:false,
    dataType:"JSON",
    beforeSend: function (data) {
      swal({
