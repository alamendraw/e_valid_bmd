      ...
      <fieldset>
        ...
        <div class="row">
          <div class="col-md-6 bor-right">
            ...
            <div class="form-group">
              <label class="control-label col-sm-5">Bangunan (P.SP.D)</label>
              <div class="col-md-7">
                <input type="text" class="form-control input-sm" id="bangunan">
                <small><i>* <span id="bangunan_awal"></span></i></small>
              </div>
            </div>
          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
              <label class="control-label col-sm-5">Tanggal Mulai</label>
              <div class="col-md-7">
                <div class="input-group date">
                  <input type="text" class="form-control datepicker input-sm" id="tgl_mulai"  readonly><span class="input-group-addon"><i class="glyphicon glyphicon-th"></i></span>
                </div>
                <small><i>* <span id="tgl_mulai_awal"></span></i></small>
              </div>
            </div>
...
<script src="<?php echo base_url(); ?>assets/js/v_form_f.js" type="text/javascript"></script>
