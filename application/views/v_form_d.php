<style>
  ...
  .hover:hover{
    color: #ffe102!important; text-yellow
    cursor: pointer;
  }
</style>
        ...
        <div class="row">
          <div class="col-md-6 bor-right">
            ...
            <div class="form-group">
              ...
              <div class="col-md-7">
                <input type="text" class="form-control input-sm" id="konstruksi" name="konstruksi">
                <small><i>* <span id="konstruksi_awal"></span></i></small>
              </div>
            </div>

            <div class="form-group">
              <label class="control-label col-sm-5">Panjang(Km)</label>
              <div class="col-md-7">
                <input type="text" class="form-control input-sm" id="panjang" name="panjang">
                <small><i>* <span id="panjang_awal"></span></i></small>
              </div>
            </div>

            <div class="form-group">
              <label class="control-label col-sm-5">Lebar(M)</label>
              <div class="col-md-7">
                <input type="text" class="form-control input-sm" id="lebar" name="lebar">
                <small><i>* <span id="lebar_awal"></span></i></small>
              </div>
            </div>

            <div class="form-group">
              <label class="control-label col-sm-5">Luas(m<sup>2</sup>)</label>
              <div class="col-md-7">
...
<script src="<?php echo base_url(); ?>assets/js/v_form_d.js" type="text/javascript"></script>
<script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAP5P2jPNd49MKMeOphABZ2PgiYdBeS6qk&callback=initialize">
