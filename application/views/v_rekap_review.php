	...
	<div class="box">
		<div class="box-body">
			<div class="card-header">
				<h4 align="center">CETAK REKAP REVIEW</h4><hr>
			</div>
...
<script type="text/javascript">
  ...
  document.getElementById("sm34").style.color = "white";
  document.getElementById("sm34").style.fontWeight = "bold";
...
function openWindow($key){
	...
	var kd_skpd    = document.getElementById('kd_skpd').value;
	var unit_skpd  = document.getElementById('unit_skpd').value;
	var url        = "<?= base_url()?>index.php/Rekap_sensus/rekap_review";
	sub_url        = 
	'?cetak='+cetak+
