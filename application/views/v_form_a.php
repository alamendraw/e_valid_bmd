      ...
      <fieldset>
        ...
        <div class="row">
          <div class="col-md-6 bor-right">
            ...
            <div class="form-group">
              <label class="control-label col-sm-5">Pengguna</label>
              <div class="col-md-7">
                <input type="text" class="form-control input-sm" id="pengguna" name="pengguna">
                <small><i>* <span id="pengguna_awal"></span></i></small>
              </div>
            </div>
        ...
        <div class="row">
          ...
          <div class="col-md-9 bor-left"  id="ada">
            ...
            <div class="form-group">
              ...
              <div class="col-md-9">
                <label class="col-sm-12" ><input type="radio" class="radio_ada" onclick="uncheked_tidak_ada();" name="keberadaan_brg" value="SKPD" onclick="uncheked_tidak_ada();"> SKPD <span class="badge badge-pill badge-primary btn-info" data-toggle="popover" data-placement="top" data-content="Keterangan: Digunakan, dipinjampakai ke instansi pemerintah yang lain, atau IDLE.">?</span></label>
            ...
            <div class="form-group">
              ...
              <div class="col-md-9">
                <label class="col-sm-12" ><input type="radio" class="radio_ada" onclick="uncheked_tidak_ada();"  name="bukti_milik" value="Ada"> Ada(Sertifikat Tanah)<input type="text" class="form-control input-sm" id="sertifikat" name="sertifikat" placeholder="No. Sertifikat"></label>
...
<script src="<?php echo base_url(); ?>assets/js/v_form_a.js" type="text/javascript"></script>
