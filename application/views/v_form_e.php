      ...
      <fieldset>
        ...
        <div class="row">
          <div class="col-md-6 bor-right">
            ...
            <div class="form-group">
              <label class="control-label col-sm-5">Judul</label>
              <div class="col-md-7">
                <input type="text" class="form-control input-sm" id="judul">
                <small><i>* <span id="judul_awal"></span></i></small>
              </div>
            </div>

            <div class="form-group">
              <label class="control-label col-sm-5">Spesifikasi</label>
              <div class="col-md-7">
                <input type="text" class="form-control input-sm" id="spesifikasi">
                <small><i>* <span id="spesifikasi_awal"></span></i></small>
              </div>
            </div>

            <div class="form-group">
              <label class="control-label col-sm-5">Asal Daerah</label>
              <div class="col-md-7">
                <input type="text" class="form-control input-sm" id="asal">
                <small><i>* <span id="asal_awal"></span></i></small>
              </div>
            </div>

            <div class="form-group">
              <label class="control-label col-sm-5">Pencipta</label>
              <div class="col-md-7">
                <input type="text" class="form-control input-sm" id="pencipta">
                <small><i>* <span id="pencipta_awal"></span></i></small>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-md-7">
                <input type="text" class="form-control input-sm" id="kd_bahan">
          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <div class="col-md-7">
                <input type="text" class="form-control input-sm" id="jenis">
                <small><i>* <span id="jensi_awal"></span></i></small>
              </div>
            </div>

            <div class="form-group">
              <label class="control-label col-sm-5">Ukuran</label>
              <div class="col-md-7">
                <input type="text" class="form-control input-sm" id="tipe">
                <small><i>* <span id="tipe_awal"></span></i></small>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-md-7">
                <input type="text" class="form-control input-sm" id="peroleh" readonly>
              </div>
            </div>
        ...
        <div class="row">
          ...
          <div class="col-md-9 bor-left"  id="ada">
            ...
            <div class="form-group">
              ...
              <div class="col-md-9">
                <label class="col-sm-12" ><input type="radio" name="keberadaan_brg" class="radio_ada" onclick="uncheked_tidak_ada();" value="SKPD"> SKPD <span class="badge badge-pill badge-primary btn-info" data-toggle="popover" data-placement="top" data-content="Keterangan: Digunakan, dipinjampakai ke instansi pemerintah yang lain, atau IDLE.">?</span></label>
                ...
                <label class="col-sm-12" ><input type="radio" name="keberadaan_brg" class="radio_ada" onclick="uncheked_tidak_ada();" value="Dikerjasamakan dengan pihak lain"> Dikerjasamakan dengan pihak lain</label>
                <label class="col-sm-12" ><input type="radio" name="keberadaan_brg" class="radio_ada" onclick="uncheked_tidak_ada();" value="Dikuasai secara tidak sah pihak lain"> Dikuasai secara tidak sah pihak lain</label>
              </div>
            </div>
            <hr>
            <div class="form-group">
              ...
              <div class="col-md-9">
                <label class="col-sm-12" ><input type="radio" name="kondisi_brg" class="radio_ada" onclick="uncheked_tidak_ada();" value="B"> Baik</label>
                <label class="col-sm-12" ><input type="radio" name="kondisi_brg" class="radio_ada" onclick="uncheked_tidak_ada();" value="KB"> Kurang Baik</label>
                <label class="col-sm-12" ><input type="radio" name="kondisi_brg" class="radio_ada" onclick="uncheked_tidak_ada();" value="RB"> Rusak Berat</label>
              </div>
            </div>
            <hr>
            <div class="form-group">
              ...
              <div class="col-md-9">
                <label class="col-sm-12" ><input type="radio" name="stat_hukum" class="radio_ada" onclick="uncheked_tidak_ada();" value="Tidak Dalam Gugatan Hukum"> Tidak Dalam Gugatan Hukum</label>
                <label class="col-sm-12" ><input type="radio" name="stat_hukum" class="radio_ada" onclick="uncheked_tidak_ada();" value="Dalam Gugatan Hukum"> Dalam Gugatan Hukum<input type="text" class="form-control input-sm" id="ket_stat_hukum" name="ket_stat_hukum" placeholder="Keterangan"></label>
              </div>
            </div>
            <hr hidden="true">
            <div class="form-group" hidden="true">
              ...
              <div class="col-md-9">
                <label class="col-sm-12" ><input type="radio"  name="bukti_milik" onclick="uncheked_tidak_ada();" value="Ada"> Ada</label><!-- class="radio_ada" -->
                <label class="col-sm-12" ><input type="radio"  name="bukti_milik" onclick="uncheked_tidak_ada();" value="Tidak Ada" checked> Tidak Ada</label><!-- class="radio_ada" -->
              </div>
            </div>
            <hr>
            <div class="form-group">
...
<script src="<?php echo base_url(); ?>assets/js/v_form_e.js" type="text/javascript"></script>
