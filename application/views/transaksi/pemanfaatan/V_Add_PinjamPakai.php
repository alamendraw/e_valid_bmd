...
<div class="row" id="sum_show">
    <div class="col-md-5 text-right col-md-offset-4">
        <h4><span>Total Pinjam Pakai: </span></h4>
    </div>
...
<div id="dlg" class="easyui-dialog" style="width:1100px" closed="true" buttons="#dlg-buttons">
		...
		<form id="popfm" method="post" novalidate style="padding: 8px;" enctype="multipart/form-data">
            <div class="popdg col-md-5">
                ...
                <div style="margin-bottom: 10px">
                    <div class="col-sm-12" style="padding-bottom: 10px;">
                        <div class="col-sm-5"><label>Nilai Pinjam Pakai</label></div>
                        <div class="col-sm-7">
            ...
            <div class="col-md-8">
                ...
                <div class="row" style="padding-top: 10px;">
                    <div class="col-sm-12">
                        <div class="col-sm-10">
                            <p class="text-right"><b>Total Pinjam Pakai: </b></p>
                        </div>
                        <div class="col-sm-2">
			...
			<div class="col-md-8">
                <div class="row" style="padding-top: 10px;">   
					<div class="col-sm-12" style="padding-bottom: 10px;">					
                        <div class="col-sm-3"><label>Uraian Pinjam Pakai</label></div>
                        <div class="col-sm-8">
...
<script type="text/javascript">
    ...
    function back() {
        localStorage.clear();
        window.location.href = "<?php echo base_url(); ?>transaksi/C_PinjamPakai";
    }

    function max_number(){ 
        $.ajax({
            type: "POST",
            url: '<?php echo base_url(); ?>transaksi/C_PinjamPakai/max_number',
            data: ({table:'transaksi.trh_pinjampakai',kolom:'no_dokumen'}),
            dataType:"json",
	...
	function saveData(){
		...
		$.post('<?php echo base_url(); ?>transaksi/C_PinjamPakai/saveData', {detail: JSON.stringify(data1),no_dok:no_dokumen,tgl_dok:tgl_dokumen,kd_skpd:kd_skpd,tahun:tahun,program:program,total:total,status:status}, function(result) {
		if (result.notif){
				iziToast.success({
					title: 'OK',
    ...
    function load_detail() {
        ...
        $.ajax({
            url: '<?php echo site_url('transaksi/C_PinjamPakai/trd_pinjampakai') ?>',
            type: 'POST',
            dataType: 'json',
            ...
            success: function(data) {
                ...
                bp     	= n['biaya_pinjampakai'];
                up     	= n['uraian_pinjampakai'];
                ...
                $('#trd').datagrid('appendRow',
                    {no_dokumen:no,
                        ...
                        jumlah:jml,
                        harga:hrg,
                        biaya_pinjampakai:bp,
                        uraian_pinjampakai:up,
                        //ket:ket,
						kd_kegiatan:kd_keg,
                        no_urut:no_urut });  
    ...
    $(document).ready(function() {
        ...
        $('#trd').datagrid({
			...
			nowrap:true,
			remoteSort:true,
            url: '<?php echo base_url(); ?>transaksi/C_PinjamPakai/trd_pinjampakai',
            ...
            columns:[[
                ...
                {field:'biaya_pinjampakai',title:'Biaya Pinjam Pakai',width:125,align:"right",editor:{type:'numberbox',options:{precision:2}}},
                {field:'uraian_pinjampakai',title:'Uraian',width:150,align:"left",editor:'text'},
        ...
        $('#dg').datagrid({
            ...
            columns:[[
                ...
                {field:'biaya_pinjampakai',title:'Biaya Pinjam Pakai',width:125,align:"left"},
                {field:'uraian_pinjampakai',title:'Uraian',width:150,align:"left"},
                {field:'kd_kegiatan',title:'Kegiatan',width:150,align:"left"},
                {field:'ck',title:'',width:1,align:'center',checkbox:true}
            ]]
        ...
        $('#kd_skpd').combogrid({
            ...
            textField:'kd_skpd',  
            mode:'remote',
            url: '<?php echo base_url(); ?>transaksi/C_PinjamPakai/getSkpd',
            columns:[[  
            ...
            onSelect:function(rowIndex,rowData){
			  ...
			  /*  var ab = $('#kd_skpd').combogrid('grid'); 
			   ...
			   $('#program').combogrid({url: '<?php echo base_url(); ?>transaksi/C_PinjamPakai/getProgram',queryParams:({kode:kd})});
		...
		$('#program').combogrid({
            ...
            mode:'remote',
            url: '<?php echo base_url(); ?>transaksi/C_PinjamPakai/getProgram',
            columns:[[  
            ...
            onSelect:function(rowIndex,rowData){
			   ...
			   nmprog.textContent = nm;
					$('#kegiatan').combogrid({
						...
						mode:'remote',
						url: '<?php echo base_url(); ?>transaksi/C_PinjamPakai/getKegiatan',
						queryParams:({kode:kd}),
						columns:[[  
						...
						onSelect:function(rowIndex,rowData){
						   ...
						   $('#kegiatan').val(kd);
							$('#kelompok').combogrid({url: '<?php echo base_url(); ?>transaksi/C_PinjamPakai/getKelompok'});
						}  
					});
            }  
        });
	...
	$('#kelompok').combogrid({
            ...
            textField:'kelompok',  
            mode:'remote',
            //url: '<?php echo base_url(); ?>transaksi/C_PinjamPakai/getKelompok',
            columns:[[  
            ...
            onSelect:function(rowIndex,rowData){
               kel = rowData.kelompok;	
					$('#jenis').combogrid({
						...
						textField:'jenis',  
						mode:'remote',
						url: '<?php echo base_url(); ?>transaksi/C_PinjamPakai/getJenis',
						queryParams:({kel: kel}),
						columns:[[  
						...
						onSelect:function(rowIndex,rowData){
						   ...
						   $('#kd_brg').combogrid({
								url: '<?php echo base_url(); ?>transaksi/C_PinjamPakai/getBarang',
								...
								onSelect:function(rowIndex, rowData) {
									...
									$('#satuan').combogrid({url: '<?php echo base_url(); ?>transaksi/C_PinjamPakai/getSatuan'});
        ...
        $('#satuan').combogrid({
            ...
            textField:'nm_satuan',  
            mode:'remote',
            //url:'<?php echo base_url(); ?>transaksi/C_PinjamPakai/getSatuan',  
            columns:[[  
