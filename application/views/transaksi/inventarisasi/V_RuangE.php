...
<script type="text/javascript">
	$(document).ready(function(){
		$('#dg').datagrid({
			...
			fitColumns:true,
			pagination:true,
			url: '<?php echo base_url(); ?>transaksi/C_Kibe/load_ruang',
		    loadMsg:"Tunggu Sebentar....!!",
//  , , , , ,a. ,a. ,a. ,b. ,c. ,a.cipta,a.penerbit,kondisi,judul
		    frozenColumns:[[
			...
			columns:[[
	    		...
	    		{field:'judul', title:'Judul', width:'15%', align:"center"}, 
	    		{field:'cipta', title:'Pencipta', width:'15%', align:"center"}, 
	    		{field:'penerbit', title:'Penerbit', width:'15%', align:"center"}, 
	    		{field:'kondisi', title:'KOndisi', width:'15%', align:"center"}, 
		...
		$('#kd_ruang').combogrid({
            ...
            textField:'nm_ruang',  
            mode:'remote',
            url:'<?php echo base_url(); ?>transaksi/C_Kibe/getRuang', 
            columns:[[  
    ...
    function proses(){
		...
		var kode = ids.join('#');
		if ( row ){
			$.post('<?php echo base_url(); ?>transaksi/C_Kibe/prosesPindah',
