    ...
    <div class="row">
        <div class="col-md-6">
           ...
           <div style="margin-bottom:10px">
            ...
            <div style="margin-bottom:10px">
                <div class="col-sm-12" style="padding-bottom: 10px;">
                    <div class="col-sm-4" style="padding-top: 3px;"><label>Ket_Matriks</label></div>
                    <div class="col-sm-8">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
		...
		$('#ket_matriks').combogrid({
            ...
            mode:'remote',
            url:'<?php echo base_url(); ?>transaksi/C_Kibg/getmatriks', 
            columns:[[  
	...
	function getBarang(){  
        ...
        $('#dgBarang').datagrid({
            ...
            queryParams:({akun:'1',kelompok:'5',jenis:'3',rincian:'1.5.3',sub_rincian:'01',key:xkey}),
            loadMsg: 'Tunggu Sebentar ... !', 
            frozenColumns:[[
                {field:'ck',title:'',width:1,align:'center',checkbox:true},
            ]],
