...
<script type="text/javascript">
	...
	window.onload = function(){
        ...
        if (status == 'detail') {
            ...
            $("#foto11").css("background-image", "url('<?php echo base_url();?>uploads/kibC/"+gambar1+"')");
            $("#foto21").css("background-image", "url('<?php echo base_url();?>uploads/kibC/"+gambar2+"')");
            $("#foto31").css("background-image", "url('<?php echo base_url();?>uploads/kibC/"+gambar3+"')");
            $("#foto41").css("background-image", "url('<?php echo base_url();?>uploads/kibC/"+gambar4+"')");
    ...
    $(document).ready(function() {
        ...
        $('#rincian').combogrid({
            ...
            columns:[[  
               ...
               {field:'uraian',title:'Objek',width:440}    
            ]],
			onSelect:function(rowIndex,rowData){
        ...
        $('#ket_matriks').combogrid({
            ...
            mode:'remote',
            url:'<?php echo base_url(); ?>transaksi/C_Kibc/getmatriks', 
            columns:[[  
...
function hapus(field) {
    $.messager.confirm('Konfirmasi','Yakin ingin menghapus foto ini?',function(r){
        if (r){
            $.ajax({
                url:'<?php echo base_url();?>transaksi/C_Kibc/hapus_img',
                type:'POST',
                dataType:'JSON',
