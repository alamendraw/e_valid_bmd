<div class="row">
	<div class="col-sm-12">
		<div class="box-header">
			...
			<div style="padding-left: 0px !important;" class="col-sm-2">
				<button id="back" type="button" class="btn btn-warning btn-sm" onClick="javascript:back();"><span><i class="fa fa-arrow-left"></i></span> Menu KIB C</button>  
				<div class="help-block with-errors" id="error_custom1"></div>
			</div>  
		</div>
	</div>
