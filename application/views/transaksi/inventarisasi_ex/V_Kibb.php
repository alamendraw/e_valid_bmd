...
<script type="text/javascript">
	function aset(){ 
		window.location.href = '<?php echo site_url('transaksi/C_Kibb/dataAset'); ?>';
	}

	function eca(){
		window.location.href = '<?php echo site_url('transaksi/C_Kibb/dataEca'); ?>';
	}

	function ruang(){
		window.location.href = '<?php echo site_url('transaksi/C_Kibb/dataRuang'); ?>';
	}
</script>