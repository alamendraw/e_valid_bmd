...
<div class="row">
	<div class="col-sm-12"> 
		...
		<div style="padding-left: 0px !important; padding-bottom: 10px;"  class="col-sm-6"><input type="text" value="" id="keyword3" name="keyword3" class="form-control" placeholder="sumber dana / panjang / luas / lebar / alamat / kondisi / keterangan "></div> 
	</div>
	<div class="col-sm-12">
		<table id="dg"></table>
	</div>
