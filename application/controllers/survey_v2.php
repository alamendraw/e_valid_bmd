...
class Survey_v2 extends CI_Controller {
	...
	function cetak(){
		...
		$cRet_1  ="
			...
			<table style=\"border-collapse:collapse;\" width=\"100%\" border=\"0\" cellspacing=\"1\" cellpadding=\"3\">
				<tr>
					<td width=\"40%\" colspan=\"5\" align=\"center\"><b>sKERTAS KERJA SURVEY<br>VALIDASI BMD MILIK DAERAH<br><br>A. PELAKSANAAN SENSUS<br><br></b></td>
				</tr>
				<tr>
			...
			<table style=\"border-collapse:collapse;\" width=\"100%\" border=\"1\" cellspacing=\"1\" cellpadding=\"3\">
				<thead>
					<tr>
						...
						<th width=\"40%\" align=\"center\" valign=\"middle\">Nama Tanah</th>
						<th width=\"5%\" align=\"center\" valign=\"middle\">Tahun</th>
						<th width=\"15%\" align=\"center\" valign=\"middle\">Nilai Perolehan</th>
						<th width=\"15%\" align=\"center\" valign=\"middle\">Keterangan</th>
				...
				<tbody>";
				$query_a = $this->db->query("SELECT no_sensus,CONCAT(nm_brg,(IF(detail_brg ='','',' / ')),detail_brg) AS nm_brg,tahun,nilai,(CASE WHEN stat_fisik='1' THEN CONCAT(keberadaan_brg,IF(keberadaan_brg<>'',' / ',''),kondisi_brg) when stat_fisik='0' THEN ket_brg else '' END) AS keterangan FROM trkib_a WHERE kd_unit='$kd_unit' ORDER BY no_sensus");
		...
		$cRet_2 .="
					<tr>
						...
						<td align=\"left\" valign=\"top\">$row_a[keterangan]</td>
		...
		$cRet_3 ="
			...
			<table style=\"border-collapse:collapse;\" width=\"100%\" border=\"1\" cellspacing=\"1\" cellpadding=\"3\">
				<thead>
					<tr>
						<th width=\"10%\" align=\"center\" valign=\"middle\">Kode Sensus</th>
						<th width=\"40%\" align=\"center\" valign=\"middle\">Nama Peralatan & Mesin</th>
						<th width=\"5%\" align=\"center\" valign=\"middle\">Tahun</th>
						<th width=\"15%\" align=\"center\" valign=\"middle\">Nilai Perolehan</th>
						<th width=\"15%\" align=\"center\" valign=\"middle\">Laporan UPB</th>
						<th width=\"10%\" align=\"center\" valign=\"middle\">Hasil Survey</th>
					</tr>
					<tr style=\"background-color:#ededed;\">
						<th align=\"center\" valign=\"middle\"></th>
						<th align=\"left\"   valign=\"middle\">A. TERDAFTAR DI KIB</th>
				...
				<tbody>";
		$query_b = $this->db->query("SELECT no_sensus,CONCAT(nm_brg,(IF(detail_brg ='','',' / ')),detail_brg) AS nm_brg,tahun,nilai,(CASE WHEN stat_fisik='1' THEN CONCAT(keberadaan_brg,IF(keberadaan_brg<>'',' / ',''),kondisi_brg) when stat_fisik='0' THEN ket_brg else '' END) AS keterangan FROM trkib_b WHERE kd_unit='$kd_unit' $ruang_value ORDER BY no_sensus $limit_value");
		...
		$cRet_3 .="
					<tr>
						...
						<td align=\"left\" 	 valign=\"top\">$row_b[keterangan]</td>
						<td align=\"center\" valign=\"top\"></td>
					</tr>";
				}
		$cRet_3 .="
		...
		$cRet_4 ="
			...
			<table style=\"border-collapse:collapse;\" width=\"100%\" border=\"1\" cellspacing=\"1\" cellpadding=\"3\">
				<thead>
					<tr>
						<th width=\"10%\" align=\"center\" valign=\"middle\">Kode Sensus</th>
						<th width=\"40%\" align=\"center\" valign=\"middle\">Nama Gedung & Bangunan</th>
						<th width=\"5%\" align=\"center\" valign=\"middle\">Tahun</th>
						<th width=\"15%\" align=\"center\" valign=\"middle\">Nilai Perolehan</th>
						<th width=\"15%\" align=\"center\" valign=\"middle\">Keterangan</th>
						<th width=\"10%\" align=\"center\" valign=\"middle\">Notasi</th>
				...
				<tbody>";
		$query_c = $this->db->query("SELECT no_sensus,CONCAT(nm_brg,(IF(detail_brg ='','',' / ')),detail_brg) AS nm_brg,tahun,nilai,(CASE WHEN stat_fisik='1' THEN CONCAT(keberadaan_brg,IF(keberadaan_brg<>'',' / ',''),kondisi_brg) when stat_fisik='0' THEN ket_brg else '' END) AS keterangan FROM trkib_c WHERE kd_unit='$kd_unit' ORDER BY no_sensus");
		...
		$cRet_4 .="
					<tr>
						...
						<td align=\"left\"   valign=\"top\">$row_c[keterangan]</td>
						<td align=\"center\" valign=\"top\"></td>
					</tr>";
				}
		$cRet_4 .="
		...
		$cRet_5 ="
			...
			<table style=\"border-collapse:collapse;\" width=\"100%\" border=\"1\" cellspacing=\"1\" cellpadding=\"3\">
				<thead>
					<tr>
						<th width=\"10%\" align=\"center\" valign=\"middle\">Kode Sensus</th>
						<th width=\"40%\" align=\"center\" valign=\"middle\">Nama Jalan, Irigasi & Jaringan</th>
						<th width=\"5%\" align=\"center\" valign=\"middle\">Tahun</th>
						<th width=\"15%\" align=\"center\" valign=\"middle\">Nilai Perolehan</th>
						<th width=\"15%\" align=\"center\" valign=\"middle\">Laporan UPB</th>
						<th width=\"10%\" align=\"center\" valign=\"middle\">Hasil Survey</th>
				...
				<tbody>";
		$query_d = $this->db->query("SELECT no_sensus,CONCAT(nm_brg,(IF(detail_brg ='','',' / ')),detail_brg) AS nm_brg,tahun,nilai,(CASE WHEN stat_fisik='1' THEN CONCAT(keberadaan_brg,IF(keberadaan_brg<>'',' / ',''),kondisi_brg) when stat_fisik='0' THEN ket_brg else '' END) AS keterangan FROM trkib_d WHERE kd_unit='$kd_unit' ORDER BY no_sensus");
		...
		$cRet_5 .="
					<tr>
						...
						<td align=\"left\" valign=\"top\">$row_d[keterangan]</td>
						<td align=\"center\" valign=\"top\"></td>
					</tr>";
				}
		$cRet_5 .="
		...
		$cRet_6 ="
			...
			<table style=\"border-collapse:collapse;\" width=\"100%\" border=\"1\" cellspacing=\"1\" cellpadding=\"3\">
				<thead>
					<tr>
						<th width=\"10%\" align=\"center\" valign=\"middle\">Kode Sensus</th>
						<th width=\"40%\" align=\"center\" valign=\"middle\">Nama Aset Tetap Lainnya</th>
						<th width=\"5%\" align=\"center\" valign=\"middle\">Tahun</th>
						<th width=\"15%\" align=\"center\" valign=\"middle\">Nilai Perolehan</th>
						<th width=\"15%\" align=\"center\" valign=\"middle\">Laporan UPB</th>
						<th width=\"10%\" align=\"center\" valign=\"middle\">Hasil Survey</th>
				...
				<tbody>";
		$query_e = $this->db->query("SELECT no_sensus,CONCAT(nm_brg,(IF(detail_brg ='','',' / ')),detail_brg) AS nm_brg,tahun,nilai,(CASE WHEN stat_fisik='1' THEN CONCAT(keberadaan_brg,IF(keberadaan_brg<>'',' / ',''),kondisi_brg) when stat_fisik='0' THEN ket_brg else '' END) AS keterangan FROM trkib_e WHERE kd_unit='$kd_unit' $ruang_value ORDER BY no_sensus $limit_value");
		...
		$cRet_6 .="
					<tr>
						...
						<td align=\"left\" valign=\"top\">$row_e[keterangan]</td>
						<td align=\"center\" valign=\"top\"></td>
					</tr>";
				}
		$cRet_6 .="
		...
		$cRet_7 ="
			...
			<table style=\"border-collapse:collapse;\" width=\"100%\" border=\"1\" cellspacing=\"1\" cellpadding=\"3\">
				<thead>
					<tr>
						<th width=\"10%\" align=\"center\" valign=\"middle\">Kode Sensus</th>
						<th width=\"40%\" align=\"center\" valign=\"middle\">Nama Konstruk dalam Pengerjaan</th>
						<th width=\"5%\" align=\"center\" valign=\"middle\">Tahun</th>
						<th width=\"15%\" align=\"center\" valign=\"middle\">Nilai Perolehan</th>
						<th width=\"15%\" align=\"center\" valign=\"middle\">Laporan UPB</th>
						<th width=\"10%\" align=\"center\" valign=\"middle\">Hasil Survey</th>
				...
				<tbody>";
		$query_f = $this->db->query("SELECT no_sensus,CONCAT(nm_brg,(IF(detail_brg ='','',' / ')),detail_brg) AS nm_brg,tahun,nilai,(CASE WHEN stat_fisik='1' THEN CONCAT(keberadaan_brg,IF(keberadaan_brg<>'',' / ',''),kondisi_brg) when stat_fisik='0' THEN ket_brg else '' END) AS keterangan FROM trkib_f WHERE kd_unit='$kd_unit' ORDER BY no_sensus");
		...
		$cRet_7 .="
					<tr>
						...
						<td align=\"center\" valign=\"top\">$row_f[keterangan]</td>
						<td align=\"center\" valign=\"top\"></td>
					</tr>";
				}
		$cRet_7 .="
		...
		$cRet  .="
			...
			<table style=\"border-collapse:collapse;\" width=\"100%\" border=\"0\" cellspacing=\"1\" cellpadding=\"3\">
				...
				<tr>
					<td colspan=\"5\" align=\"center\" style=\"font-size:23px\"><br><br><br><br><br>
						<img style=\"height:265px\" src='".base_url('assets/images/logo_grey.png')."'><br><br><br><br><br><br><br><br><br><br><br>
					</td>
				</tr>
				<tr>
					<td colspan=\"5\" align=\"center\" style=\"font-size:23px\"><b>
				...
				<tr>
					...
					<td colspan=\"2\" align=\"left\">
						<table>
							...
							<tr>
							<tr>
								<td valign=\"bottom\" width=\"100%\" rowspan=\"3\"><br><br><br><u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</u></td>
							<tr>
						</table>
					</td>
				</tr>
		...
		$cRet  .="
			...
			<table style=\"border-collapse:collapse;\" width=\"100%\" border=\"0\" cellspacing=\"1\" cellpadding=\"3\">
				<tr>
					<td width=\"40%\" colspan=\"5\" align=\"center\"><b>KERTAS KERJA SURVEY<br>VALIDASI BMD MILIK DAERAH<br></b></td>
				</tr>
				<tr>
					<td width=\"40%\" colspan=\"5\" align=\"center\"><b>B-01. IDENTIFIKASI LAY OUT TANAH<br><br></b></td>
				</tr>
			</table>
			<table style=\"border-collapse:collapse; \" width=\"100%\" border=\"1\" cellspacing=\"1\" cellpadding=\"3\">
				<tr>
		...
		$cRet .="
			...
			<table style=\"border-collapse:collapse;\" width=\"100%\" border=\"0\" cellspacing=\"1\" cellpadding=\"3\">
				<tr>
					<td width=\"40%\" colspan=\"5\" align=\"center\"><b>KERTAS KERJA SURVEY<br>VALIDASI BMD MILIK DAERAH</b></td>
				</tr>
				<tr>
					<td width=\"40%\" colspan=\"5\" align=\"center\"><b>B-02. UJI PETIK SENSUS PERALATAN DAN MESIN<br><br></b></td>
				</tr>
			</table>
			<table style=\"border-collapse:collapse; \" width=\"100%\" border=\"1\" cellspacing=\"1\" cellpadding=\"3\">
				<tr>
		...
		$cRet .="
			...
			<table style=\"border-collapse:collapse;\" width=\"100%\" border=\"0\" cellspacing=\"1\" cellpadding=\"3\">
				...
				<tr>
					<td width=\"40%\" colspan=\"5\" align=\"center\"><b>B-03. IDENTIFIKASI LAY-OUT GEDUNG DAN BANGUNAN<br><br></b></td>
				</tr>
			</table>
			<table style=\"border-collapse:collapse; \" width=\"100%\" border=\"1\" cellspacing=\"1\" cellpadding=\"3\">
				<tr>
		...
		$cRet .="
			...
			<table style=\"border-collapse:collapse;\" width=\"100%\" border=\"0\" cellspacing=\"1\" cellpadding=\"3\">
				...
				<tr>
					<td width=\"40%\" colspan=\"5\" align=\"center\"><b>B-04. UJI PETIK SENSUS JALAN IRIGASI DAN JARINGAN<br><br></b></td>
				</tr>
			</table>
			<table style=\"border-collapse:collapse; \" width=\"100%\" border=\"1\" cellspacing=\"1\" cellpadding=\"3\">
				<tr>
		...
		$cRet .="
			...
			<table style=\"border-collapse:collapse;\" width=\"100%\" border=\"0\" cellspacing=\"1\" cellpadding=\"3\">
				...
				<tr>
					<td width=\"40%\" colspan=\"5\" align=\"center\"><b>B-05. UJI PETIK SENSUS ASET TETAP LAINNYA<br><br></b></td>
				</tr>
			</table>
			<table style=\"border-collapse:collapse; \" width=\"100%\" border=\"1\" cellspacing=\"1\" cellpadding=\"3\">
				<tr>
		...
		$cRet .="
			...
			<table style=\"border-collapse:collapse;\" width=\"100%\" border=\"0\" cellspacing=\"1\" cellpadding=\"3\">
				...
				<tr>
					<td width=\"40%\" colspan=\"5\" align=\"center\"><b>B-06. UJI PETIK SENSUS KONSTRUKSI DALAM PENGERJAAN<br><br></b></td>
				</tr>
			</table>
			<table style=\"border-collapse:collapse; \" width=\"100%\" border=\"1\" cellspacing=\"1\" cellpadding=\"3\">
				<tr>
		...
		if ($cetak==1) {
			...
			if ($jns_kib==0) {
				...
				$data['excel'] = $cRet_2/*.$cRet_3.$cRet_4.$cRet_5.$cRet_6.$cRet_7*/;
			}elseif ($jns_kib==2) {
				$data['excel'] = $cRet_3;
			}elseif ($jns_kib==3) {
				$data['excel'] = $cRet_4;
			...
			$this->load->view('doc', $data);
				...
				$this->M_model->_mpdf_label('P',10,10,10,10,0,0,'',$cRet,'FOLIO');
