...
class Rekap_sensus extends CI_Controller {
	...
	function cetak_lap_penetapan(){
		...
		<table class=\"border-collapse w-100\" border=\"1\">
			...
			(CASE WHEN keberadaan_brg2<>'' AND keberadaan_brg2 IS NOT NULL THEN keberadaan_brg2 ELSE keberadaan_brg END)='SKPD'
			THEN 'Aset Tetap'
			...
			$sql = "SELECT nor,kol_2,kol_3,kol_4,kol_5,kol_5a,kol_6,kol_7,kol_8,kol_9,kol_10,kol_11,kol_12,kol_13,sum(kol_14)kol_14,sum(kol_15)kol_15,kol_16,kol_17,kol_18,kol_19 from (
					...
					UNION ALL
					select * from (
						SELECT '2a' AS nor, kd_brg AS kol_2, no_reg AS kol_3, no_sensus AS kol_4, nm_brg AS kol_5,(CASE WHEN detail_brg2 IS NOT NULL THEN detail_brg2 ELSE detail_brg END)kol_5a, (case when jenis_gedung2 is not null then jenis_gedung2 else jenis_gedung end) AS kol_6, (CASE WHEN no_dok2 IS NOT NULL THEN no_dok2 ELSE no_dok END) as kol_7, '' AS kol_8, asal AS kol_9, tahun AS kol_10, (CASE WHEN konstruksi3 IS NOT NULL THEN konstruksi3 ELSE konstruksi2 END)kol_11, '' AS kol_12, (case when kondisi_brg2<>'' AND kondisi_brg2 IS NOT NULL THEN kondisi_brg2 when kondisi_brg IS NOT NULL AND kondisi_brg<>'' then kondisi_brg else kondisi end) AS kol_13, jumlah AS kol_14, (SELECT IFNULL(SUM(nilai),0) from trkib_c_kap a where a.kd_skpd=b.kd_skpd and a.kd_unit=b.kd_unit and a.id_barang=b.id_barang and tmbh_manfaat<>'0')+IFNULL(nilai,0) AS kol_15, (CASE WHEN keterangan2 IS NOT NULL THEN keterangan2 ELSE keterangan END)kol_16, (CASE WHEN keberadaan_brg2<>'' AND keberadaan_brg2 IS NOT NULL THEN(CASE WHEN keberadaan_brg2='SKPD' THEN 'SKPD-Digunakan' WHEN keberadaan_brg2='Dikerjasamakan dengan pihak lain' THEN 'SKPD-Dikerjasamakan' WHEN keberadaan_brg2='Dikuasai secara tidak sah pihak lain' THEN 'SKPD-Dikuasai Pihak Lain' END) WHEN ket_brg2<>'' AND ket_brg2 IS NOT NULL THEN ket_brg2 WHEN STATUS='1' AND stat_fisik='1' THEN (CASE WHEN keberadaan_brg='SKPD' THEN 'SKPD-Digunakan' WHEN keberadaan_brg='Dikerjasamakan dengan pihak lain' THEN 'SKPD-Dikerjasamakan' WHEN keberadaan_brg='Dikuasai secara tidak sah pihak lain' THEN 'SKPD-Dikuasai Pihak Lain' END) WHEN STATUS='1' AND stat_fisik='0' THEN ket_brg END)kol_17, (CASE WHEN LEFT(kd_brg_new,5)='1.3.1' THEN 'A' WHEN LEFT(kd_brg_new,5)='1.3.2' THEN 'B' WHEN LEFT(kd_brg_new,5)='1.3.3' THEN 'C' WHEN LEFT(kd_brg_new,5)='1.3.4' THEN 'D' WHEN LEFT(kd_brg_new,5)='1.3.5' THEN 'E' WHEN LEFT(kd_brg_new,5)='1.3.6' THEN 'F' ELSE '' END) AS kol_18, $status_aset_akhir as kol_19 FROM trkib_c b WHERE id_lama='Aset Lainnya' $where_skpd $where_unit 
						union all
						...
						union all
						SELECT '2a' AS nor, kd_brg AS kol_2, no_reg AS kol_3, no_sensus AS kol_4, nm_brg AS kol_5,(CASE WHEN detail_brg2 IS NOT NULL THEN detail_brg2 ELSE detail_brg END)kol_5a, (case when tipe2 is not null then tipe2 else tipe end) AS kol_6, (case when spesifikasi2 is not null then spesifikasi2 else spesifikasi end) kol_7, (case when kd_bahan2 is not null then kd_bahan2 else kd_bahan end) AS kol_8, concat(peroleh,'/',dsr_peroleh) AS kol_9, tahun AS kol_10, '' as kol_11, kd_satuan AS kol_12, (case when kondisi_brg2<>'' AND kondisi_brg2 IS NOT NULL THEN kondisi_brg2 when kondisi_brg IS NOT NULL AND kondisi_brg<>'' then kondisi_brg else kondisi end) AS kol_13, jumlah AS kol_14, (SELECT IFNULL(SUM(nilai),0) from trkib_e_kap a where a.kd_skpd=b.kd_skpd and a.kd_unit=b.kd_unit and a.id_barang=b.id_barang and tmbh_manfaat<>'0')+IFNULL(nilai,0) AS kol_15, (CASE WHEN keterangan2 IS NOT NULL THEN keterangan2 ELSE keterangan END)kol_16, (CASE WHEN keberadaan_brg2<>'' AND keberadaan_brg2 IS NOT NULL THEN(CASE WHEN keberadaan_brg2='SKPD' THEN 'SKPD-Digunakan' WHEN keberadaan_brg2='Dikerjasamakan dengan pihak lain' THEN 'SKPD-Dikerjasamakan' WHEN keberadaan_brg2='Dikuasai secara tidak sah pihak lain' THEN 'SKPD-Dikuasai Pihak Lain' END) WHEN ket_brg2<>'' AND ket_brg2 IS NOT NULL THEN ket_brg2 WHEN STATUS='1' AND stat_fisik='1' THEN (CASE WHEN keberadaan_brg='SKPD' THEN 'SKPD-Digunakan' WHEN keberadaan_brg='Dikerjasamakan dengan pihak lain' THEN 'SKPD-Dikerjasamakan' WHEN keberadaan_brg='Dikuasai secara tidak sah pihak lain' THEN 'SKPD-Dikuasai Pihak Lain' END) WHEN STATUS='1' AND stat_fisik='0' THEN ket_brg END)kol_17, (CASE WHEN LEFT(kd_brg_new,5)='1.3.1' THEN 'A' WHEN LEFT(kd_brg_new,5)='1.3.2' THEN 'B' WHEN LEFT(kd_brg_new,5)='1.3.3' THEN 'C' WHEN LEFT(kd_brg_new,5)='1.3.4' THEN 'D' WHEN LEFT(kd_brg_new,5)='1.3.5' THEN 'E' WHEN LEFT(kd_brg_new,5)='1.3.6' THEN 'F' ELSE '' END) AS kol_18, $status_aset_akhir as kol_19 FROM trkib_e b WHERE id_lama='Aset Lainnya' $where_skpd $where_unit 
						union all
						SELECT '2a' AS nor, kd_brg AS kol_2, no_reg AS kol_3, no_sensus AS kol_4, nm_brg AS kol_5,(CASE WHEN detail_brg2 IS NOT NULL THEN detail_brg2 ELSE detail_brg END)kol_5a, '' AS kol_6, '' as kol_7, '' AS kol_8, concat(asal,'/',dsr_peroleh) AS kol_9, tahun AS kol_10, (CASE WHEN konstruksi2 IS NOT NULL THEN konstruksi2 ELSE konstruksi END)kol_11, '' AS kol_12, (case when kondisi_brg2<>'' AND kondisi_brg2 IS NOT NULL THEN kondisi_brg2 when kondisi_brg IS NOT NULL AND kondisi_brg<>'' then kondisi_brg else kondisi end) AS kol_13, jumlah AS kol_14, nilai AS kol_15, (CASE WHEN keterangan2 IS NOT NULL THEN keterangan2 ELSE keterangan END)kol_16, (CASE WHEN keberadaan_brg2<>'' AND keberadaan_brg2 IS NOT NULL THEN(CASE WHEN keberadaan_brg2='SKPD' THEN 'SKPD-Digunakan' WHEN keberadaan_brg2='Dikerjasamakan dengan pihak lain' THEN 'SKPD-Dikerjasamakan' WHEN keberadaan_brg2='Dikuasai secara tidak sah pihak lain' THEN 'SKPD-Dikuasai Pihak Lain' END) WHEN ket_brg2<>'' AND ket_brg2 IS NOT NULL THEN ket_brg2 WHEN STATUS='1' AND stat_fisik='1' THEN (CASE WHEN keberadaan_brg='SKPD' THEN 'SKPD-Digunakan' WHEN keberadaan_brg='Dikerjasamakan dengan pihak lain' THEN 'SKPD-Dikerjasamakan' WHEN keberadaan_brg='Dikuasai secara tidak sah pihak lain' THEN 'SKPD-Dikuasai Pihak Lain' END) WHEN STATUS='1' AND stat_fisik='0' THEN ket_brg END)kol_17, (CASE WHEN LEFT(kd_brg_new,5)='1.3.1' THEN 'A' WHEN LEFT(kd_brg_new,5)='1.3.2' THEN 'B' WHEN LEFT(kd_brg_new,5)='1.3.3' THEN 'C' WHEN LEFT(kd_brg_new,5)='1.3.4' THEN 'D' WHEN LEFT(kd_brg_new,5)='1.3.5' THEN 'E' WHEN LEFT(kd_brg_new,5)='1.3.6' THEN 'F' ELSE '' END) AS kol_18, $status_aset_akhir as kol_19 FROM trkib_f WHERE id_lama='Aset Lainnya' $where_skpd $where_unit 
					)lainnya_detail
					UNION ALL
					SELECT nor,kol_2,kol_3,kol_4,kol_5,kol_5a,kol_6,kol_7,kol_8,kol_9,kol_10,kol_11,kol_12,kol_13,sum(kol_14)kol_14,SUM(kol_15)kol_15,kol_16,kol_17,kol_18,kol_19 FROM (
						SELECT '3' AS nor, '' AS kol_2, '' AS kol_3, '' AS kol_4, 'ECA' AS kol_5, '' AS kol_5a, '' AS kol_6, '' AS kol_7, '' AS kol_8, '' AS kol_9, '' AS kol_10, '' AS kol_11, '' AS kol_12, '' AS kol_13, sum(jumlah) AS kol_14, (SELECT IFNULL(SUM(nilai),0) from trkib_a_kap a where a.kd_skpd=b.kd_skpd and a.kd_unit=b.kd_unit and a.id_barang=b.id_barang and tmbh_manfaat<>'0')+IFNULL(SUM(nilai),0) AS kol_15, 'SUBTOOTAL' AS kol_16, '' AS kol_17, '' AS kol_18, '' AS kol_19 FROM trkib_a b WHERE id_lama='Eca' $where_skpd $where_unit  GROUP BY id_barang
						UNION ALL
						SELECT '3' AS nor, '' AS kol_2, '' AS kol_3, '' AS kol_4, 'ECA' AS kol_5, '' AS kol_5a, '' AS kol_6, '' AS kol_7, '' AS kol_8, '' AS kol_9, '' AS kol_10, '' AS kol_11, '' AS kol_12, '' AS kol_13, sum(jumlah) AS kol_14, (SELECT IFNULL(SUM(nilai),0) from trkib_b_kap a where a.kd_skpd=b.kd_skpd and a.kd_unit=b.kd_unit and a.id_barang=b.id_barang and tmbh_manfaat<>'0')+IFNULL(SUM(nilai),0) AS kol_15, 'SUBTOOTAL' AS kol_16, '' AS kol_17, '' AS kol_18, '' AS kol_19 FROM trkib_b b WHERE id_lama='Eca' $where_skpd $where_unit  GROUP BY id_barang
						UNION ALL
						SELECT '3' AS nor, '' AS kol_2, '' AS kol_3, '' AS kol_4, 'ECA' AS kol_5, '' AS kol_5a, '' AS kol_6, '' AS kol_7, '' AS kol_8, '' AS kol_9, '' AS kol_10, '' AS kol_11, '' AS kol_12, '' AS kol_13, sum(jumlah) AS kol_14, (SELECT IFNULL(SUM(nilai),0) from trkib_c_kap a where a.kd_skpd=b.kd_skpd and a.kd_unit=b.kd_unit and a.id_barang=b.id_barang and tmbh_manfaat<>'0')+IFNULL(SUM(nilai),0) AS kol_15, 'SUBTOOTAL' AS kol_16, '' AS kol_17, '' AS kol_18, '' AS kol_19 FROM trkib_c b WHERE id_lama='Eca' $where_skpd $where_unit  GROUP BY id_barang
						UNION ALL
						SELECT '3' AS nor, '' AS kol_2, '' AS kol_3, '' AS kol_4, 'ECA' AS kol_5, '' AS kol_5a, '' AS kol_6, '' AS kol_7, '' AS kol_8, '' AS kol_9, '' AS kol_10, '' AS kol_11, '' AS kol_12, '' AS kol_13, sum(jumlah) AS kol_14, (SELECT IFNULL(SUM(nilai),0) from trkib_d_kap a where a.kd_skpd=b.kd_skpd and a.kd_unit=b.kd_unit and a.id_barang=b.id_barang and tmbh_manfaat<>'0')+IFNULL(SUM(nilai),0) AS kol_15, 'SUBTOOTAL' AS kol_16, '' AS kol_17, '' AS kol_18, '' AS kol_19 FROM trkib_d b WHERE id_lama='Eca' $where_skpd $where_unit  GROUP BY id_barang
						UNION ALL
						SELECT '3' AS nor, '' AS kol_2, '' AS kol_3, '' AS kol_4, 'ECA' AS kol_5, '' AS kol_5a, '' AS kol_6, '' AS kol_7, '' AS kol_8, '' AS kol_9, '' AS kol_10, '' AS kol_11, '' AS kol_12, '' AS kol_13, sum(jumlah) AS kol_14, (SELECT IFNULL(SUM(nilai),0) from trkib_e_kap a where a.kd_skpd=b.kd_skpd and a.kd_unit=b.kd_unit and a.id_barang=b.id_barang and tmbh_manfaat<>'0')+IFNULL(SUM(nilai),0) AS kol_15, 'SUBTOOTAL' AS kol_16, '' AS kol_17, '' AS kol_18, '' AS kol_19 FROM trkib_e b WHERE id_lama='Eca' $where_skpd $where_unit  GROUP BY id_barang
						UNION ALL
					...
					UNION ALL
					SELECT * FROM (
						SELECT '3a' AS nor, kd_brg AS kol_2, no_reg AS kol_3, no_sensus AS kol_4, nm_brg AS kol_5,(CASE WHEN detail_brg2 IS NOT NULL THEN detail_brg2 ELSE detail_brg END)kol_5a, '' AS kol_6, (CASE WHEN no_sertifikat2 IS NOT NULL THEN no_sertifikat2 ELSE no_sertifikat END) kol_7, '' AS kol_8, asal AS kol_9, tahun AS kol_10, (CASE WHEN luas2 IS NOT NULL THEN luas2 ELSE luas END)kol_11, '' AS kol_12, (case when kondisi_brg2<>'' AND kondisi_brg2 IS NOT NULL THEN kondisi_brg2 when kondisi_brg IS NOT NULL AND kondisi_brg<>'' then kondisi_brg else kondisi end) AS kol_13, jumlah AS kol_14, (SELECT IFNULL(SUM(nilai),0) from trkib_a_kap a where a.kd_skpd=b.kd_skpd and a.kd_unit=b.kd_unit and a.id_barang=b.id_barang and tmbh_manfaat<>'0')+IFNULL(nilai,0) AS kol_15, (CASE WHEN keterangan2 IS NOT NULL THEN keterangan2 ELSE keterangan END)kol_16, (CASE WHEN keberadaan_brg2<>'' AND keberadaan_brg2 IS NOT NULL THEN(CASE WHEN keberadaan_brg2='SKPD' THEN 'SKPD-Digunakan' WHEN keberadaan_brg2='Dikerjasamakan dengan pihak lain' THEN 'SKPD-Dikerjasamakan' WHEN keberadaan_brg2='Dikuasai secara tidak sah pihak lain' THEN 'SKPD-Dikuasai Pihak Lain' END) WHEN ket_brg2<>'' AND ket_brg2 IS NOT NULL THEN ket_brg2 WHEN STATUS='1' AND stat_fisik='1' THEN (CASE WHEN keberadaan_brg='SKPD' THEN 'SKPD-Digunakan' WHEN keberadaan_brg='Dikerjasamakan dengan pihak lain' THEN 'SKPD-Dikerjasamakan' WHEN keberadaan_brg='Dikuasai secara tidak sah pihak lain' THEN 'SKPD-Dikuasai Pihak Lain' END) WHEN STATUS='1' AND stat_fisik='0' THEN ket_brg END)kol_17, (CASE WHEN LEFT(kd_brg_new,5)='1.3.1' THEN 'A' WHEN LEFT(kd_brg_new,5)='1.3.2' THEN 'B' WHEN LEFT(kd_brg_new,5)='1.3.3' THEN 'C' WHEN LEFT(kd_brg_new,5)='1.3.4' THEN 'D' WHEN LEFT(kd_brg_new,5)='1.3.5' THEN 'E' WHEN LEFT(kd_brg_new,5)='1.3.6' THEN 'F' ELSE '' END) AS kol_18, 'Eca' AS kol_19 FROM trkib_a b WHERE id_lama='Eca' $where_skpd $where_unit 
						union all
						SELECT '3a' AS nor, kd_brg AS kol_2, no_reg AS kol_3, no_sensus AS kol_4, nm_brg AS kol_5,(CASE WHEN detail_brg2 IS NOT NULL THEN detail_brg2 ELSE detail_brg END)kol_5a, (case when merek2 IS NOT NULL THEN merek2 ELSE merek end) AS kol_6, concat(pabrik2,'/',no_rangka2,'/',no_mesin2,'/',no_polisi2) kol_7, kd_bahan AS kol_8, concat(asal,'/',dsr_peroleh) AS kol_9, tahun AS kol_10, (CASE WHEN silinder2 IS NOT NULL THEN silinder2 ELSE silinder END)kol_11, kd_satuan AS kol_12, (case when kondisi_brg2<>'' AND kondisi_brg2 IS NOT NULL THEN kondisi_brg2 when kondisi_brg IS NOT NULL AND kondisi_brg<>'' then kondisi_brg else kondisi end) AS kol_13, jumlah AS kol_14, (SELECT IFNULL(SUM(nilai),0) from trkib_b_kap a where a.kd_skpd=b.kd_skpd and a.kd_unit=b.kd_unit and a.id_barang=b.id_barang and tmbh_manfaat<>'0')+IFNULL(nilai,0) AS kol_15, (CASE WHEN keterangan2 IS NOT NULL THEN keterangan2 ELSE keterangan END)kol_16, (CASE WHEN keberadaan_brg2<>'' AND keberadaan_brg2 IS NOT NULL THEN(CASE WHEN keberadaan_brg2='SKPD' THEN 'SKPD-Digunakan' WHEN keberadaan_brg2='Dikerjasamakan dengan pihak lain' THEN 'SKPD-Dikerjasamakan' WHEN keberadaan_brg2='Dikuasai secara tidak sah pihak lain' THEN 'SKPD-Dikuasai Pihak Lain' END) WHEN ket_brg2<>'' AND ket_brg2 IS NOT NULL THEN ket_brg2 WHEN STATUS='1' AND stat_fisik='1' THEN (CASE WHEN keberadaan_brg='SKPD' THEN 'SKPD-Digunakan' WHEN keberadaan_brg='Dikerjasamakan dengan pihak lain' THEN 'SKPD-Dikerjasamakan' WHEN keberadaan_brg='Dikuasai secara tidak sah pihak lain' THEN 'SKPD-Dikuasai Pihak Lain' END) WHEN STATUS='1' AND stat_fisik='0' THEN ket_brg END)kol_17, (CASE WHEN LEFT(kd_brg_new,5)='1.3.1' THEN 'A' WHEN LEFT(kd_brg_new,5)='1.3.2' THEN 'B' WHEN LEFT(kd_brg_new,5)='1.3.3' THEN 'C' WHEN LEFT(kd_brg_new,5)='1.3.4' THEN 'D' WHEN LEFT(kd_brg_new,5)='1.3.5' THEN 'E' WHEN LEFT(kd_brg_new,5)='1.3.6' THEN 'F' ELSE '' END) AS kol_18, 'Eca' AS kol_19 FROM trkib_b b WHERE id_lama='Eca' $where_skpd $where_unit 
						union all
						SELECT '3a' AS nor, kd_brg AS kol_2, no_reg AS kol_3, no_sensus AS kol_4, nm_brg AS kol_5,(CASE WHEN detail_brg2 IS NOT NULL THEN detail_brg2 ELSE detail_brg END)kol_5a, (case when jenis_gedung2 is not null then jenis_gedung2 else jenis_gedung end) AS kol_6, (CASE WHEN no_dok2 IS NOT NULL THEN no_dok2 ELSE no_dok END) as kol_7, '' AS kol_8, asal AS kol_9, tahun AS kol_10, (CASE WHEN konstruksi3 IS NOT NULL THEN konstruksi3 ELSE konstruksi2 END)kol_11, '' AS kol_12, (case when kondisi_brg2<>'' AND kondisi_brg2 IS NOT NULL THEN kondisi_brg2 when kondisi_brg IS NOT NULL AND kondisi_brg<>'' then kondisi_brg else kondisi end) AS kol_13, jumlah AS kol_14, (SELECT IFNULL(SUM(nilai),0) from trkib_c_kap a where a.kd_skpd=b.kd_skpd and a.kd_unit=b.kd_unit and a.id_barang=b.id_barang and tmbh_manfaat<>'0')+IFNULL(nilai,0) AS kol_15, (CASE WHEN keterangan2 IS NOT NULL THEN keterangan2 ELSE keterangan END)kol_16, (CASE WHEN keberadaan_brg2<>'' AND keberadaan_brg2 IS NOT NULL THEN(CASE WHEN keberadaan_brg2='SKPD' THEN 'SKPD-Digunakan' WHEN keberadaan_brg2='Dikerjasamakan dengan pihak lain' THEN 'SKPD-Dikerjasamakan' WHEN keberadaan_brg2='Dikuasai secara tidak sah pihak lain' THEN 'SKPD-Dikuasai Pihak Lain' END) WHEN ket_brg2<>'' AND ket_brg2 IS NOT NULL THEN ket_brg2 WHEN STATUS='1' AND stat_fisik='1' THEN (CASE WHEN keberadaan_brg='SKPD' THEN 'SKPD-Digunakan' WHEN keberadaan_brg='Dikerjasamakan dengan pihak lain' THEN 'SKPD-Dikerjasamakan' WHEN keberadaan_brg='Dikuasai secara tidak sah pihak lain' THEN 'SKPD-Dikuasai Pihak Lain' END) WHEN STATUS='1' AND stat_fisik='0' THEN ket_brg END)kol_17, (CASE WHEN LEFT(kd_brg_new,5)='1.3.1' THEN 'A' WHEN LEFT(kd_brg_new,5)='1.3.2' THEN 'B' WHEN LEFT(kd_brg_new,5)='1.3.3' THEN 'C' WHEN LEFT(kd_brg_new,5)='1.3.4' THEN 'D' WHEN LEFT(kd_brg_new,5)='1.3.5' THEN 'E' WHEN LEFT(kd_brg_new,5)='1.3.6' THEN 'F' ELSE '' END) AS kol_18, 'Eca' AS kol_19 FROM trkib_c b WHERE id_lama='Eca' $where_skpd $where_unit 
						union all
						SELECT '3a' AS nor, kd_brg AS kol_2, no_reg AS kol_3, no_sensus AS kol_4, nm_brg AS kol_5,(CASE WHEN detail_brg2 IS NOT NULL THEN detail_brg2 ELSE detail_brg END)kol_5a, '' AS kol_6, (CASE WHEN no_dok2 IS NOT NULL THEN no_dok2 ELSE no_dok END) AS kol_7, '' AS kol_8, asal AS kol_9, tahun AS kol_10, (CASE WHEN konstruksi2 IS NOT NULL THEN konstruksi2 ELSE konstruksi END)kol_11, '' AS kol_12, (case when kondisi_brg2<>'' AND kondisi_brg2 IS NOT NULL THEN kondisi_brg2 when kondisi_brg IS NOT NULL AND kondisi_brg<>'' then kondisi_brg else kondisi end) AS kol_13, jumlah AS kol_14, (SELECT IFNULL(SUM(nilai),0) from trkib_d_kap a where a.kd_skpd=b.kd_skpd and a.kd_unit=b.kd_unit and a.id_barang=b.id_barang and tmbh_manfaat<>'0')+IFNULL(nilai,0) AS kol_15, (CASE WHEN keterangan2 IS NOT NULL THEN keterangan2 ELSE keterangan END)kol_16, (CASE WHEN keberadaan_brg2<>'' AND keberadaan_brg2 IS NOT NULL THEN(CASE WHEN keberadaan_brg2='SKPD' THEN 'SKPD-Digunakan' WHEN keberadaan_brg2='Dikerjasamakan dengan pihak lain' THEN 'SKPD-Dikerjasamakan' WHEN keberadaan_brg2='Dikuasai secara tidak sah pihak lain' THEN 'SKPD-Dikuasai Pihak Lain' END) WHEN ket_brg2<>'' AND ket_brg2 IS NOT NULL THEN ket_brg2 WHEN STATUS='1' AND stat_fisik='1' THEN (CASE WHEN keberadaan_brg='SKPD' THEN 'SKPD-Digunakan' WHEN keberadaan_brg='Dikerjasamakan dengan pihak lain' THEN 'SKPD-Dikerjasamakan' WHEN keberadaan_brg='Dikuasai secara tidak sah pihak lain' THEN 'SKPD-Dikuasai Pihak Lain' END) WHEN STATUS='1' AND stat_fisik='0' THEN ket_brg END)kol_17, (CASE WHEN LEFT(kd_brg_new,5)='1.3.1' THEN 'A' WHEN LEFT(kd_brg_new,5)='1.3.2' THEN 'B' WHEN LEFT(kd_brg_new,5)='1.3.3' THEN 'C' WHEN LEFT(kd_brg_new,5)='1.3.4' THEN 'D' WHEN LEFT(kd_brg_new,5)='1.3.5' THEN 'E' WHEN LEFT(kd_brg_new,5)='1.3.6' THEN 'F' ELSE '' END) AS kol_18, 'Eca' AS kol_19 FROM trkib_d b WHERE id_lama='Aset Tetap' $where_skpd $where_unit
						union all
						SELECT '3a' AS nor, kd_brg AS kol_2, no_reg AS kol_3, no_sensus AS kol_4, nm_brg AS kol_5,(CASE WHEN detail_brg2 IS NOT NULL THEN detail_brg2 ELSE detail_brg END)kol_5a, (case when tipe2 is not null then tipe2 else tipe end) AS kol_6, (case when spesifikasi2 is not null then spesifikasi2 else spesifikasi end) kol_7, (case when kd_bahan2 is not null then kd_bahan2 else kd_bahan end) AS kol_8, concat(peroleh,'/',dsr_peroleh) AS kol_9, tahun AS kol_10, '' as kol_11, kd_satuan AS kol_12, (case when kondisi_brg2<>'' AND kondisi_brg2 IS NOT NULL THEN kondisi_brg2 when kondisi_brg IS NOT NULL AND kondisi_brg<>'' then kondisi_brg else kondisi end) AS kol_13, jumlah AS kol_14, (SELECT IFNULL(SUM(nilai),0) from trkib_e_kap a where a.kd_skpd=b.kd_skpd and a.kd_unit=b.kd_unit and a.id_barang=b.id_barang and tmbh_manfaat<>'0')+IFNULL(nilai,0) AS kol_15, (CASE WHEN keterangan2 IS NOT NULL THEN keterangan2 ELSE keterangan END)kol_16, (CASE WHEN keberadaan_brg2<>'' AND keberadaan_brg2 IS NOT NULL THEN(CASE WHEN keberadaan_brg2='SKPD' THEN 'SKPD-Digunakan' WHEN keberadaan_brg2='Dikerjasamakan dengan pihak lain' THEN 'SKPD-Dikerjasamakan' WHEN keberadaan_brg2='Dikuasai secara tidak sah pihak lain' THEN 'SKPD-Dikuasai Pihak Lain' END) WHEN ket_brg2<>'' AND ket_brg2 IS NOT NULL THEN ket_brg2 WHEN STATUS='1' AND stat_fisik='1' THEN (CASE WHEN keberadaan_brg='SKPD' THEN 'SKPD-Digunakan' WHEN keberadaan_brg='Dikerjasamakan dengan pihak lain' THEN 'SKPD-Dikerjasamakan' WHEN keberadaan_brg='Dikuasai secara tidak sah pihak lain' THEN 'SKPD-Dikuasai Pihak Lain' END) WHEN STATUS='1' AND stat_fisik='0' THEN ket_brg END)kol_17, (CASE WHEN LEFT(kd_brg_new,5)='1.3.1' THEN 'A' WHEN LEFT(kd_brg_new,5)='1.3.2' THEN 'B' WHEN LEFT(kd_brg_new,5)='1.3.3' THEN 'C' WHEN LEFT(kd_brg_new,5)='1.3.4' THEN 'D' WHEN LEFT(kd_brg_new,5)='1.3.5' THEN 'E' WHEN LEFT(kd_brg_new,5)='1.3.6' THEN 'F' ELSE '' END) AS kol_18, 'Eca' AS kol_19 FROM trkib_e b WHERE id_lama='Eca' $where_skpd $where_unit 
						union all
						SELECT '3a' AS nor, kd_brg AS kol_2, no_reg AS kol_3, no_sensus AS kol_4, nm_brg AS kol_5,(CASE WHEN detail_brg2 IS NOT NULL THEN detail_brg2 ELSE detail_brg END)kol_5a, '' AS kol_6, '' as kol_7, '' AS kol_8, concat(asal,'/',dsr_peroleh) AS kol_9, tahun AS kol_10, (CASE WHEN konstruksi2 IS NOT NULL THEN konstruksi2 ELSE konstruksi END)kol_11, '' AS kol_12, (case when kondisi_brg2<>'' AND kondisi_brg2 IS NOT NULL THEN kondisi_brg2 when kondisi_brg IS NOT NULL AND kondisi_brg<>'' then kondisi_brg else kondisi end) AS kol_13, jumlah AS kol_14, nilai AS kol_15, (CASE WHEN keterangan2 IS NOT NULL THEN keterangan2 ELSE keterangan END)kol_16, (CASE WHEN keberadaan_brg2<>'' AND keberadaan_brg2 IS NOT NULL THEN(CASE WHEN keberadaan_brg2='SKPD' THEN 'SKPD-Digunakan' WHEN keberadaan_brg2='Dikerjasamakan dengan pihak lain' THEN 'SKPD-Dikerjasamakan' WHEN keberadaan_brg2='Dikuasai secara tidak sah pihak lain' THEN 'SKPD-Dikuasai Pihak Lain' END) WHEN ket_brg2<>'' AND ket_brg2 IS NOT NULL THEN ket_brg2 WHEN STATUS='1' AND stat_fisik='1' THEN (CASE WHEN keberadaan_brg='SKPD' THEN 'SKPD-Digunakan' WHEN keberadaan_brg='Dikerjasamakan dengan pihak lain' THEN 'SKPD-Dikerjasamakan' WHEN keberadaan_brg='Dikuasai secara tidak sah pihak lain' THEN 'SKPD-Dikuasai Pihak Lain' END) WHEN STATUS='1' AND stat_fisik='0' THEN ket_brg END)kol_17, (CASE WHEN LEFT(kd_brg_new,5)='1.3.1' THEN 'A' WHEN LEFT(kd_brg_new,5)='1.3.2' THEN 'B' WHEN LEFT(kd_brg_new,5)='1.3.3' THEN 'C' WHEN LEFT(kd_brg_new,5)='1.3.4' THEN 'D' WHEN LEFT(kd_brg_new,5)='1.3.5' THEN 'E' WHEN LEFT(kd_brg_new,5)='1.3.6' THEN 'F' ELSE '' END) AS kol_18, 'Eca' AS kol_19 FROM trkib_f WHERE id_lama='Eca' $where_skpd $where_unit 
					)eca_detail
					order by nor,kol_2";
		$res       = $this->db->query($sql);
		$no        = 1;
		...
		<table class=\"border-collapse w-100\" border=\"1\">
			...
			$sql =" SELECT '1' AS col_1,col_2,col_3,SUM(col_4)col_4,'Aset Tetap' AS col_5,col_6,col_7,col_8,col_9,col_10,col_11,col_12,col_13 FROM (
					...
					SELECT col_1,col_2,col_3,col_4,col_5,col_6,col_7,col_8,col_9,col_10,col_11,col_12,col_13 FROM (
						SELECT '1a' AS col_1, CONCAT(kd_unit,'.',no_sensus) AS col_2,tahun AS col_3,(SELECT IFNULL(SUM(nilai),0) FROM trkib_a_kap a WHERE a.kd_skpd=b.kd_skpd AND a.kd_unit=b.kd_unit AND a.id_barang=b.id_barang AND tmbh_manfaat<>'0')+IFNULL(SUM(nilai),0) AS col_4, kd_brg AS col_5, CONCAT(nm_brg,IF(detail_brg<>'' && detail_brg IS NOT NULL,'/',''),IFNULL(detail_brg,'')) AS col_6, 'A' AS col_7, $status_aset_awal AS col_8, kd_brg_new AS col_9, CONCAT(nm_brg_new,IF(detail_brg2<>'' && detail_brg2 IS NOT NULL,'/',''),IFNULL(detail_brg2,'')) AS col_10, (CASE WHEN keberadaan_brg2<>'' AND keberadaan_brg2 IS NOT NULL THEN(CASE WHEN keberadaan_brg2='SKPD' THEN 'SKPD-Digunakan' WHEN keberadaan_brg2='Dikerjasamakan dengan pihak lain' THEN 'SKPD-Dikerjasamakan' WHEN keberadaan_brg2='Dikuasai secara tidak sah pihak lain' THEN 'SKPD-Dikuasai Pihak Lain' END) WHEN ket_brg2<>'' AND ket_brg2 IS NOT NULL THEN ket_brg2 WHEN STATUS='1' AND stat_fisik='1' THEN (CASE WHEN keberadaan_brg='SKPD' THEN 'SKPD-Digunakan' WHEN keberadaan_brg='Dikerjasamakan dengan pihak lain' THEN 'SKPD-Dikerjasamakan' WHEN keberadaan_brg='Dikuasai secara tidak sah pihak lain' THEN 'SKPD-Dikuasai Pihak Lain' END) WHEN STATUS='1' AND stat_fisik='0' THEN ket_brg END) AS col_11, (CASE WHEN LEFT(kd_brg_new,5)='1.3.1' THEN 'A' WHEN LEFT(kd_brg_new,5)='1.3.2' THEN 'B' WHEN LEFT(kd_brg_new,5)='1.3.3' THEN 'C' WHEN LEFT(kd_brg_new,5)='1.3.4' THEN 'D' WHEN LEFT(kd_brg_new,5)='1.3.5' THEN 'E' WHEN LEFT(kd_brg_new,5)='1.3.6' THEN 'F' ELSE '' END) AS col_12, $status_aset_akhir AS col_13 FROM trkib_a b WHERE $status_aset_awal = 'Aset Tetap' $where_skpd $where_unit GROUP BY id_barang UNION ALL
						SELECT '1a' AS col_1, CONCAT(kd_unit,'.',no_sensus) AS col_2,tahun AS col_3,(SELECT IFNULL(SUM(nilai),0) FROM trkib_b_kap a WHERE a.kd_skpd=b.kd_skpd AND a.kd_unit=b.kd_unit AND a.id_barang=b.id_barang AND tmbh_manfaat<>'0')+IFNULL(SUM(nilai),0) AS col_4, kd_brg AS col_5, CONCAT(nm_brg,IF(detail_brg<>'' && detail_brg IS NOT NULL,'/',''),IFNULL(detail_brg,'')) AS col_6, 'B' AS col_7, $status_aset_awal AS col_8, kd_brg_new AS col_9, CONCAT(nm_brg_new,IF(detail_brg2<>'' && detail_brg2 IS NOT NULL,'/',''),IFNULL(detail_brg2,'')) AS col_10, (CASE WHEN keberadaan_brg2<>'' AND keberadaan_brg2 IS NOT NULL THEN(CASE WHEN keberadaan_brg2='SKPD' THEN 'SKPD-Digunakan' WHEN keberadaan_brg2='Dikerjasamakan dengan pihak lain' THEN 'SKPD-Dikerjasamakan' WHEN keberadaan_brg2='Dikuasai secara tidak sah pihak lain' THEN 'SKPD-Dikuasai Pihak Lain' END) WHEN ket_brg2<>'' AND ket_brg2 IS NOT NULL THEN ket_brg2 WHEN STATUS='1' AND stat_fisik='1' THEN (CASE WHEN keberadaan_brg='SKPD' THEN 'SKPD-Digunakan' WHEN keberadaan_brg='Dikerjasamakan dengan pihak lain' THEN 'SKPD-Dikerjasamakan' WHEN keberadaan_brg='Dikuasai secara tidak sah pihak lain' THEN 'SKPD-Dikuasai Pihak Lain' END) WHEN STATUS='1' AND stat_fisik='0' THEN ket_brg END) AS col_11, (CASE WHEN LEFT(kd_brg_new,5)='1.3.1' THEN 'A' WHEN LEFT(kd_brg_new,5)='1.3.2' THEN 'B' WHEN LEFT(kd_brg_new,5)='1.3.3' THEN 'C' WHEN LEFT(kd_brg_new,5)='1.3.4' THEN 'D' WHEN LEFT(kd_brg_new,5)='1.3.5' THEN 'E' WHEN LEFT(kd_brg_new,5)='1.3.6' THEN 'F' ELSE '' END) AS col_12, $status_aset_akhir AS col_13 FROM trkib_b b WHERE $status_aset_awal = 'Aset Tetap' $where_skpd $where_unit GROUP BY id_barang UNION ALL
						SELECT '1a' AS col_1, CONCAT(kd_unit,'.',no_sensus) AS col_2,tahun AS col_3,(SELECT IFNULL(SUM(nilai),0) FROM trkib_c_kap a WHERE a.kd_skpd=b.kd_skpd AND a.kd_unit=b.kd_unit AND a.id_barang=b.id_barang AND tmbh_manfaat<>'0')+IFNULL(SUM(nilai),0) AS col_4, kd_brg AS col_5, CONCAT(nm_brg,IF(detail_brg<>'' && detail_brg IS NOT NULL,'/',''),IFNULL(detail_brg,'')) AS col_6, 'C' AS col_7, $status_aset_awal AS col_8, kd_brg_new AS col_9, CONCAT(nm_brg_new,IF(detail_brg2<>'' && detail_brg2 IS NOT NULL,'/',''),IFNULL(detail_brg2,'')) AS col_10, (CASE WHEN keberadaan_brg2<>'' AND keberadaan_brg2 IS NOT NULL THEN(CASE WHEN keberadaan_brg2='SKPD' THEN 'SKPD-Digunakan' WHEN keberadaan_brg2='Dikerjasamakan dengan pihak lain' THEN 'SKPD-Dikerjasamakan' WHEN keberadaan_brg2='Dikuasai secara tidak sah pihak lain' THEN 'SKPD-Dikuasai Pihak Lain' END) WHEN ket_brg2<>'' AND ket_brg2 IS NOT NULL THEN ket_brg2 WHEN STATUS='1' AND stat_fisik='1' THEN (CASE WHEN keberadaan_brg='SKPD' THEN 'SKPD-Digunakan' WHEN keberadaan_brg='Dikerjasamakan dengan pihak lain' THEN 'SKPD-Dikerjasamakan' WHEN keberadaan_brg='Dikuasai secara tidak sah pihak lain' THEN 'SKPD-Dikuasai Pihak Lain' END) WHEN STATUS='1' AND stat_fisik='0' THEN ket_brg END) AS col_11, (CASE WHEN LEFT(kd_brg_new,5)='1.3.1' THEN 'A' WHEN LEFT(kd_brg_new,5)='1.3.2' THEN 'B' WHEN LEFT(kd_brg_new,5)='1.3.3' THEN 'C' WHEN LEFT(kd_brg_new,5)='1.3.4' THEN 'D' WHEN LEFT(kd_brg_new,5)='1.3.5' THEN 'E' WHEN LEFT(kd_brg_new,5)='1.3.6' THEN 'F' ELSE '' END) AS col_12, $status_aset_akhir AS col_13 FROM trkib_c b WHERE $status_aset_awal = 'Aset Tetap' $where_skpd $where_unit GROUP BY id_barang UNION ALL
						SELECT '1a' AS col_1, CONCAT(kd_unit,'.',no_sensus) AS col_2,tahun AS col_3,(SELECT IFNULL(SUM(nilai),0) FROM trkib_d_kap a WHERE a.kd_skpd=b.kd_skpd AND a.kd_unit=b.kd_unit AND a.id_barang=b.id_barang AND tmbh_manfaat<>'0')+IFNULL(SUM(nilai),0) AS col_4, kd_brg AS col_5, CONCAT(nm_brg,IF(detail_brg<>'' && detail_brg IS NOT NULL,'/',''),IFNULL(detail_brg,'')) AS col_6, 'D' AS col_7, $status_aset_awal AS col_8, kd_brg_new AS col_9, CONCAT(nm_brg_new,IF(detail_brg2<>'' && detail_brg2 IS NOT NULL,'/',''),IFNULL(detail_brg2,'')) AS col_10, (CASE WHEN keberadaan_brg2<>'' AND keberadaan_brg2 IS NOT NULL THEN(CASE WHEN keberadaan_brg2='SKPD' THEN 'SKPD-Digunakan' WHEN keberadaan_brg2='Dikerjasamakan dengan pihak lain' THEN 'SKPD-Dikerjasamakan' WHEN keberadaan_brg2='Dikuasai secara tidak sah pihak lain' THEN 'SKPD-Dikuasai Pihak Lain' END) WHEN ket_brg2<>'' AND ket_brg2 IS NOT NULL THEN ket_brg2 WHEN STATUS='1' AND stat_fisik='1' THEN (CASE WHEN keberadaan_brg='SKPD' THEN 'SKPD-Digunakan' WHEN keberadaan_brg='Dikerjasamakan dengan pihak lain' THEN 'SKPD-Dikerjasamakan' WHEN keberadaan_brg='Dikuasai secara tidak sah pihak lain' THEN 'SKPD-Dikuasai Pihak Lain' END) WHEN STATUS='1' AND stat_fisik='0' THEN ket_brg END) AS col_11, (CASE WHEN LEFT(kd_brg_new,5)='1.3.1' THEN 'A' WHEN LEFT(kd_brg_new,5)='1.3.2' THEN 'B' WHEN LEFT(kd_brg_new,5)='1.3.3' THEN 'C' WHEN LEFT(kd_brg_new,5)='1.3.4' THEN 'D' WHEN LEFT(kd_brg_new,5)='1.3.5' THEN 'E' WHEN LEFT(kd_brg_new,5)='1.3.6' THEN 'F' ELSE '' END) AS col_12, $status_aset_akhir AS col_13 FROM trkib_d b WHERE $status_aset_awal = 'Aset Tetap' $where_skpd $where_unit GROUP BY id_barang UNION ALL
						SELECT '1a' AS col_1, CONCAT(kd_unit,'.',no_sensus) AS col_2,tahun AS col_3,(SELECT IFNULL(SUM(nilai),0) FROM trkib_e_kap a WHERE a.kd_skpd=b.kd_skpd AND a.kd_unit=b.kd_unit AND a.id_barang=b.id_barang AND tmbh_manfaat<>'0')+IFNULL(SUM(nilai),0) AS col_4, kd_brg AS col_5, CONCAT(nm_brg,IF(detail_brg<>'' && detail_brg IS NOT NULL,'/',''),IFNULL(detail_brg,'')) AS col_6, 'E' AS col_7, $status_aset_awal AS col_8, kd_brg_new AS col_9, CONCAT(nm_brg_new,IF(detail_brg2<>'' && detail_brg2 IS NOT NULL,'/',''),IFNULL(detail_brg2,'')) AS col_10, (CASE WHEN keberadaan_brg2<>'' AND keberadaan_brg2 IS NOT NULL THEN(CASE WHEN keberadaan_brg2='SKPD' THEN 'SKPD-Digunakan' WHEN keberadaan_brg2='Dikerjasamakan dengan pihak lain' THEN 'SKPD-Dikerjasamakan' WHEN keberadaan_brg2='Dikuasai secara tidak sah pihak lain' THEN 'SKPD-Dikuasai Pihak Lain' END) WHEN ket_brg2<>'' AND ket_brg2 IS NOT NULL THEN ket_brg2 WHEN STATUS='1' AND stat_fisik='1' THEN (CASE WHEN keberadaan_brg='SKPD' THEN 'SKPD-Digunakan' WHEN keberadaan_brg='Dikerjasamakan dengan pihak lain' THEN 'SKPD-Dikerjasamakan' WHEN keberadaan_brg='Dikuasai secara tidak sah pihak lain' THEN 'SKPD-Dikuasai Pihak Lain' END) WHEN STATUS='1' AND stat_fisik='0' THEN ket_brg END) AS col_11, (CASE WHEN LEFT(kd_brg_new,5)='1.3.1' THEN 'A' WHEN LEFT(kd_brg_new,5)='1.3.2' THEN 'B' WHEN LEFT(kd_brg_new,5)='1.3.3' THEN 'C' WHEN LEFT(kd_brg_new,5)='1.3.4' THEN 'D' WHEN LEFT(kd_brg_new,5)='1.3.5' THEN 'E' WHEN LEFT(kd_brg_new,5)='1.3.6' THEN 'F' ELSE '' END) AS col_12, $status_aset_akhir AS col_13 FROM trkib_e b WHERE $status_aset_awal = 'Aset Tetap' $where_skpd $where_unit GROUP BY id_barang UNION ALL
						SELECT '1a' AS col_1, CONCAT(kd_unit,'.',no_sensus) AS col_2,tahun AS col_3,IFNULL(SUM(nilai),0) AS col_4, kd_brg AS col_5, CONCAT(nm_brg,IF(detail_brg<>'' && detail_brg IS NOT NULL,'/',''),IFNULL(detail_brg,'')) AS col_6, 'F' AS col_7, $status_aset_awal AS col_8, kd_brg_new AS col_9, CONCAT(nm_brg_new,IF(detail_brg2<>'' && detail_brg2 IS NOT NULL,'/',''),IFNULL(detail_brg2,'')) AS col_10, (CASE WHEN keberadaan_brg2<>'' AND keberadaan_brg2 IS NOT NULL THEN(CASE WHEN keberadaan_brg2='SKPD' THEN 'SKPD-Digunakan' WHEN keberadaan_brg2='Dikerjasamakan dengan pihak lain' THEN 'SKPD-Dikerjasamakan' WHEN keberadaan_brg2='Dikuasai secara tidak sah pihak lain' THEN 'SKPD-Dikuasai Pihak Lain' END) WHEN ket_brg2<>'' AND ket_brg2 IS NOT NULL THEN ket_brg2 WHEN STATUS='1' AND stat_fisik='1' THEN (CASE WHEN keberadaan_brg='SKPD' THEN 'SKPD-Digunakan' WHEN keberadaan_brg='Dikerjasamakan dengan pihak lain' THEN 'SKPD-Dikerjasamakan' WHEN keberadaan_brg='Dikuasai secara tidak sah pihak lain' THEN 'SKPD-Dikuasai Pihak Lain' END) WHEN STATUS='1' AND stat_fisik='0' THEN ket_brg END) AS col_11, (CASE WHEN LEFT(kd_brg_new,5)='1.3.1' THEN 'A' WHEN LEFT(kd_brg_new,5)='1.3.2' THEN 'B' WHEN LEFT(kd_brg_new,5)='1.3.3' THEN 'C' WHEN LEFT(kd_brg_new,5)='1.3.4' THEN 'D' WHEN LEFT(kd_brg_new,5)='1.3.5' THEN 'E' WHEN LEFT(kd_brg_new,5)='1.3.6' THEN 'F' ELSE '' END) AS col_12, $status_aset_akhir AS col_13 FROM trkib_f b WHERE $status_aset_awal = 'Aset Tetap' $where_skpd $where_unit GROUP BY id_barang
					)detal_ttp
					UNION ALL
					...
					UNION ALL
					SELECT col_1,col_2,col_3,col_4,col_5,col_6,col_7,col_8,col_9,col_10,col_11,col_12,col_13 FROM (
						SELECT '2a' AS col_1, CONCAT(kd_unit,'.',no_sensus) AS col_2,tahun AS col_3,(SELECT IFNULL(SUM(nilai),0) FROM trkib_a_kap a WHERE a.kd_skpd=b.kd_skpd AND a.kd_unit=b.kd_unit AND a.id_barang=b.id_barang AND tmbh_manfaat<>'0')+IFNULL(SUM(nilai),0) AS col_4, kd_brg AS col_5, CONCAT(nm_brg,IF(detail_brg<>'' && detail_brg IS NOT NULL,'/',''),IFNULL(detail_brg,'')) AS col_6, 'A' AS col_7, $status_aset_awal AS col_8, kd_brg_new AS col_9, CONCAT(nm_brg_new,IF(detail_brg2<>'' && detail_brg2 IS NOT NULL,'/',''),IFNULL(detail_brg2,'')) AS col_10, (CASE WHEN keberadaan_brg2<>'' AND keberadaan_brg2 IS NOT NULL THEN(CASE WHEN keberadaan_brg2='SKPD' THEN 'SKPD-Digunakan' WHEN keberadaan_brg2='Dikerjasamakan dengan pihak lain' THEN 'SKPD-Dikerjasamakan' WHEN keberadaan_brg2='Dikuasai secara tidak sah pihak lain' THEN 'SKPD-Dikuasai Pihak Lain' END) WHEN ket_brg2<>'' AND ket_brg2 IS NOT NULL THEN ket_brg2 WHEN STATUS='1' AND stat_fisik='1' THEN (CASE WHEN keberadaan_brg='SKPD' THEN 'SKPD-Digunakan' WHEN keberadaan_brg='Dikerjasamakan dengan pihak lain' THEN 'SKPD-Dikerjasamakan' WHEN keberadaan_brg='Dikuasai secara tidak sah pihak lain' THEN 'SKPD-Dikuasai Pihak Lain' END) WHEN STATUS='1' AND stat_fisik='0' THEN ket_brg END) AS col_11, (CASE WHEN LEFT(kd_brg_new,5)='1.3.1' THEN 'A' WHEN LEFT(kd_brg_new,5)='1.3.2' THEN 'B' WHEN LEFT(kd_brg_new,5)='1.3.3' THEN 'C' WHEN LEFT(kd_brg_new,5)='1.3.4' THEN 'D' WHEN LEFT(kd_brg_new,5)='1.3.5' THEN 'E' WHEN LEFT(kd_brg_new,5)='1.3.6' THEN 'F' ELSE '' END) AS col_12, $status_aset_akhir AS col_13 FROM trkib_a b WHERE $status_aset_awal = 'Aset Lainnya' $where_skpd $where_unit GROUP BY id_barang UNION ALL
						SELECT '2a' AS col_1, CONCAT(kd_unit,'.',no_sensus) AS col_2,tahun AS col_3,(SELECT IFNULL(SUM(nilai),0) FROM trkib_b_kap a WHERE a.kd_skpd=b.kd_skpd AND a.kd_unit=b.kd_unit AND a.id_barang=b.id_barang AND tmbh_manfaat<>'0')+IFNULL(SUM(nilai),0) AS col_4, kd_brg AS col_5, CONCAT(nm_brg,IF(detail_brg<>'' && detail_brg IS NOT NULL,'/',''),IFNULL(detail_brg,'')) AS col_6, 'B' AS col_7, $status_aset_awal AS col_8, kd_brg_new AS col_9, CONCAT(nm_brg_new,IF(detail_brg2<>'' && detail_brg2 IS NOT NULL,'/',''),IFNULL(detail_brg2,'')) AS col_10, (CASE WHEN keberadaan_brg2<>'' AND keberadaan_brg2 IS NOT NULL THEN(CASE WHEN keberadaan_brg2='SKPD' THEN 'SKPD-Digunakan' WHEN keberadaan_brg2='Dikerjasamakan dengan pihak lain' THEN 'SKPD-Dikerjasamakan' WHEN keberadaan_brg2='Dikuasai secara tidak sah pihak lain' THEN 'SKPD-Dikuasai Pihak Lain' END) WHEN ket_brg2<>'' AND ket_brg2 IS NOT NULL THEN ket_brg2 WHEN STATUS='1' AND stat_fisik='1' THEN (CASE WHEN keberadaan_brg='SKPD' THEN 'SKPD-Digunakan' WHEN keberadaan_brg='Dikerjasamakan dengan pihak lain' THEN 'SKPD-Dikerjasamakan' WHEN keberadaan_brg='Dikuasai secara tidak sah pihak lain' THEN 'SKPD-Dikuasai Pihak Lain' END) WHEN STATUS='1' AND stat_fisik='0' THEN ket_brg END) AS col_11, (CASE WHEN LEFT(kd_brg_new,5)='1.3.1' THEN 'A' WHEN LEFT(kd_brg_new,5)='1.3.2' THEN 'B' WHEN LEFT(kd_brg_new,5)='1.3.3' THEN 'C' WHEN LEFT(kd_brg_new,5)='1.3.4' THEN 'D' WHEN LEFT(kd_brg_new,5)='1.3.5' THEN 'E' WHEN LEFT(kd_brg_new,5)='1.3.6' THEN 'F' ELSE '' END) AS col_12, $status_aset_akhir AS col_13 FROM trkib_b b WHERE $status_aset_awal = 'Aset Lainnya' $where_skpd $where_unit GROUP BY id_barang UNION ALL
						SELECT '2a' AS col_1, CONCAT(kd_unit,'.',no_sensus) AS col_2,tahun AS col_3,(SELECT IFNULL(SUM(nilai),0) FROM trkib_c_kap a WHERE a.kd_skpd=b.kd_skpd AND a.kd_unit=b.kd_unit AND a.id_barang=b.id_barang AND tmbh_manfaat<>'0')+IFNULL(SUM(nilai),0) AS col_4, kd_brg AS col_5, CONCAT(nm_brg,IF(detail_brg<>'' && detail_brg IS NOT NULL,'/',''),IFNULL(detail_brg,'')) AS col_6, 'C' AS col_7, $status_aset_awal AS col_8, kd_brg_new AS col_9, CONCAT(nm_brg_new,IF(detail_brg2<>'' && detail_brg2 IS NOT NULL,'/',''),IFNULL(detail_brg2,'')) AS col_10, (CASE WHEN keberadaan_brg2<>'' AND keberadaan_brg2 IS NOT NULL THEN(CASE WHEN keberadaan_brg2='SKPD' THEN 'SKPD-Digunakan' WHEN keberadaan_brg2='Dikerjasamakan dengan pihak lain' THEN 'SKPD-Dikerjasamakan' WHEN keberadaan_brg2='Dikuasai secara tidak sah pihak lain' THEN 'SKPD-Dikuasai Pihak Lain' END) WHEN ket_brg2<>'' AND ket_brg2 IS NOT NULL THEN ket_brg2 WHEN STATUS='1' AND stat_fisik='1' THEN (CASE WHEN keberadaan_brg='SKPD' THEN 'SKPD-Digunakan' WHEN keberadaan_brg='Dikerjasamakan dengan pihak lain' THEN 'SKPD-Dikerjasamakan' WHEN keberadaan_brg='Dikuasai secara tidak sah pihak lain' THEN 'SKPD-Dikuasai Pihak Lain' END) WHEN STATUS='1' AND stat_fisik='0' THEN ket_brg END) AS col_11, (CASE WHEN LEFT(kd_brg_new,5)='1.3.1' THEN 'A' WHEN LEFT(kd_brg_new,5)='1.3.2' THEN 'B' WHEN LEFT(kd_brg_new,5)='1.3.3' THEN 'C' WHEN LEFT(kd_brg_new,5)='1.3.4' THEN 'D' WHEN LEFT(kd_brg_new,5)='1.3.5' THEN 'E' WHEN LEFT(kd_brg_new,5)='1.3.6' THEN 'F' ELSE '' END) AS col_12, $status_aset_akhir AS col_13 FROM trkib_c b WHERE $status_aset_awal = 'Aset Lainnya' $where_skpd $where_unit GROUP BY id_barang UNION ALL
						SELECT '2a' AS col_1, CONCAT(kd_unit,'.',no_sensus) AS col_2,tahun AS col_3,(SELECT IFNULL(SUM(nilai),0) FROM trkib_d_kap a WHERE a.kd_skpd=b.kd_skpd AND a.kd_unit=b.kd_unit AND a.id_barang=b.id_barang AND tmbh_manfaat<>'0')+IFNULL(SUM(nilai),0) AS col_4, kd_brg AS col_5, CONCAT(nm_brg,IF(detail_brg<>'' && detail_brg IS NOT NULL,'/',''),IFNULL(detail_brg,'')) AS col_6, 'D' AS col_7, $status_aset_awal AS col_8, kd_brg_new AS col_9, CONCAT(nm_brg_new,IF(detail_brg2<>'' && detail_brg2 IS NOT NULL,'/',''),IFNULL(detail_brg2,'')) AS col_10, (CASE WHEN keberadaan_brg2<>'' AND keberadaan_brg2 IS NOT NULL THEN(CASE WHEN keberadaan_brg2='SKPD' THEN 'SKPD-Digunakan' WHEN keberadaan_brg2='Dikerjasamakan dengan pihak lain' THEN 'SKPD-Dikerjasamakan' WHEN keberadaan_brg2='Dikuasai secara tidak sah pihak lain' THEN 'SKPD-Dikuasai Pihak Lain' END) WHEN ket_brg2<>'' AND ket_brg2 IS NOT NULL THEN ket_brg2 WHEN STATUS='1' AND stat_fisik='1' THEN (CASE WHEN keberadaan_brg='SKPD' THEN 'SKPD-Digunakan' WHEN keberadaan_brg='Dikerjasamakan dengan pihak lain' THEN 'SKPD-Dikerjasamakan' WHEN keberadaan_brg='Dikuasai secara tidak sah pihak lain' THEN 'SKPD-Dikuasai Pihak Lain' END) WHEN STATUS='1' AND stat_fisik='0' THEN ket_brg END) AS col_11, (CASE WHEN LEFT(kd_brg_new,5)='1.3.1' THEN 'A' WHEN LEFT(kd_brg_new,5)='1.3.2' THEN 'B' WHEN LEFT(kd_brg_new,5)='1.3.3' THEN 'C' WHEN LEFT(kd_brg_new,5)='1.3.4' THEN 'D' WHEN LEFT(kd_brg_new,5)='1.3.5' THEN 'E' WHEN LEFT(kd_brg_new,5)='1.3.6' THEN 'F' ELSE '' END) AS col_12, $status_aset_akhir AS col_13 FROM trkib_d b WHERE $status_aset_awal = 'Aset Lainnya' $where_skpd $where_unit GROUP BY id_barang UNION ALL
						SELECT '2a' AS col_1, CONCAT(kd_unit,'.',no_sensus) AS col_2,tahun AS col_3,(SELECT IFNULL(SUM(nilai),0) FROM trkib_e_kap a WHERE a.kd_skpd=b.kd_skpd AND a.kd_unit=b.kd_unit AND a.id_barang=b.id_barang AND tmbh_manfaat<>'0')+IFNULL(SUM(nilai),0) AS col_4, kd_brg AS col_5, CONCAT(nm_brg,IF(detail_brg<>'' && detail_brg IS NOT NULL,'/',''),IFNULL(detail_brg,'')) AS col_6, 'E' AS col_7, $status_aset_awal AS col_8, kd_brg_new AS col_9, CONCAT(nm_brg_new,IF(detail_brg2<>'' && detail_brg2 IS NOT NULL,'/',''),IFNULL(detail_brg2,'')) AS col_10, (CASE WHEN keberadaan_brg2<>'' AND keberadaan_brg2 IS NOT NULL THEN(CASE WHEN keberadaan_brg2='SKPD' THEN 'SKPD-Digunakan' WHEN keberadaan_brg2='Dikerjasamakan dengan pihak lain' THEN 'SKPD-Dikerjasamakan' WHEN keberadaan_brg2='Dikuasai secara tidak sah pihak lain' THEN 'SKPD-Dikuasai Pihak Lain' END) WHEN ket_brg2<>'' AND ket_brg2 IS NOT NULL THEN ket_brg2 WHEN STATUS='1' AND stat_fisik='1' THEN (CASE WHEN keberadaan_brg='SKPD' THEN 'SKPD-Digunakan' WHEN keberadaan_brg='Dikerjasamakan dengan pihak lain' THEN 'SKPD-Dikerjasamakan' WHEN keberadaan_brg='Dikuasai secara tidak sah pihak lain' THEN 'SKPD-Dikuasai Pihak Lain' END) WHEN STATUS='1' AND stat_fisik='0' THEN ket_brg END) AS col_11, (CASE WHEN LEFT(kd_brg_new,5)='1.3.1' THEN 'A' WHEN LEFT(kd_brg_new,5)='1.3.2' THEN 'B' WHEN LEFT(kd_brg_new,5)='1.3.3' THEN 'C' WHEN LEFT(kd_brg_new,5)='1.3.4' THEN 'D' WHEN LEFT(kd_brg_new,5)='1.3.5' THEN 'E' WHEN LEFT(kd_brg_new,5)='1.3.6' THEN 'F' ELSE '' END) AS col_12, $status_aset_akhir AS col_13 FROM trkib_e b WHERE $status_aset_awal = 'Aset Lainnya' $where_skpd $where_unit GROUP BY id_barang UNION ALL
						SELECT '2a' AS col_1, CONCAT(kd_unit,'.',no_sensus) AS col_2,tahun AS col_3,IFNULL(SUM(nilai),0) AS col_4, kd_brg AS col_5, CONCAT(nm_brg,IF(detail_brg<>'' && detail_brg IS NOT NULL,'/',''),IFNULL(detail_brg,'')) AS col_6, 'F' AS col_7, $status_aset_awal AS col_8, kd_brg_new AS col_9, CONCAT(nm_brg_new,IF(detail_brg2<>'' && detail_brg2 IS NOT NULL,'/',''),IFNULL(detail_brg2,'')) AS col_10, (CASE WHEN keberadaan_brg2<>'' AND keberadaan_brg2 IS NOT NULL THEN(CASE WHEN keberadaan_brg2='SKPD' THEN 'SKPD-Digunakan' WHEN keberadaan_brg2='Dikerjasamakan dengan pihak lain' THEN 'SKPD-Dikerjasamakan' WHEN keberadaan_brg2='Dikuasai secara tidak sah pihak lain' THEN 'SKPD-Dikuasai Pihak Lain' END) WHEN ket_brg2<>'' AND ket_brg2 IS NOT NULL THEN ket_brg2 WHEN STATUS='1' AND stat_fisik='1' THEN (CASE WHEN keberadaan_brg='SKPD' THEN 'SKPD-Digunakan' WHEN keberadaan_brg='Dikerjasamakan dengan pihak lain' THEN 'SKPD-Dikerjasamakan' WHEN keberadaan_brg='Dikuasai secara tidak sah pihak lain' THEN 'SKPD-Dikuasai Pihak Lain' END) WHEN STATUS='1' AND stat_fisik='0' THEN ket_brg END) AS col_11, (CASE WHEN LEFT(kd_brg_new,5)='1.3.1' THEN 'A' WHEN LEFT(kd_brg_new,5)='1.3.2' THEN 'B' WHEN LEFT(kd_brg_new,5)='1.3.3' THEN 'C' WHEN LEFT(kd_brg_new,5)='1.3.4' THEN 'D' WHEN LEFT(kd_brg_new,5)='1.3.5' THEN 'E' WHEN LEFT(kd_brg_new,5)='1.3.6' THEN 'F' ELSE '' END) AS col_12, $status_aset_akhir AS col_13 FROM trkib_f b WHERE $status_aset_awal = 'Aset Lainnya' $where_skpd $where_unit GROUP BY id_barang
					)detal_lainnya
					UNION ALL
			...
			$html .="
				<tr bgcolor=\"#b8b8b8\">
					...
					<td colspan=\"10\">".number_format($jumlah,2)."</td>
				</tr>
			</tbody>
		</table>
		<br/><br/>
